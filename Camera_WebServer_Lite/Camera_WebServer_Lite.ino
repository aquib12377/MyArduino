...
void handleStream() {
  ...
  while (client.connected()) {
    ...
    // each frame: send boundary + headers + data
    client.print("--frame\r\n");
    ...
    // small delay so we don't choke WiFi; tune if needed
    delay(30);

    // allow other HTTP handling
...
bool initCamera() {
  ...
  // Optional: tweak sensor for better brightness / frames
...
void setup() {
  ...
  Serial.println("Open this in browser: http://");
  Serial.println(WiFi.localIP());
