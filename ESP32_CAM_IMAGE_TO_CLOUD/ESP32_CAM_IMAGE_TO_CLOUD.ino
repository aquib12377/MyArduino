...
String myDeploymentID = "AKfycby1uWBJ7A2vVM7hSgtyupg0cfdQPCdBi3k7I7kbbDQOiJnFf3l2GLyZzcBIdCrupFq_og";
String myMainFolderName = "ESP32-CAM";
//======================================== 

//======================================== Variables for Timer/Millis.
unsigned long previousMillis = 0; 
const int Interval = 60000; //--> Capture and Send a photo every 20 seconds.
//======================================== 
...
void setup() {
  ...
  if (psramFound()) {
    ...
    config.fb_count     = 2;                // keep double buffer
} else {
    // fall back to VGA if you ever boot without PSRAM
